...
#define down_constrainOn_SD 150       //used when down to be taken,when leg is on sanddune. 
...
{ 
  ...
  analogWrite(L3Vpwm, stall_base3v-5);
   val2v=L2V_down;
//    if(sanddune_counter==3 || sanddune_counter==4 )
//    {
//      val2v=L2V_sand_mid;
//      }
//    else
...
void state197()
{
  turn_flag=1;          /////since during sanddune retry , 45 degree will already be achieved
...
//  flag1_up=1;
//  flag3_up=1;
val2v=L2V_up_sand;        //use this for general sanddune,if counts are not working.
val4v=L4V_up_sand;
    if(sanddune_counter2<2)
  {
    val2v=L2V_down+80;
